...
for etabin in etabins:
	...
	for antype in antypes:
		...
		if antype[2] == 'Ele':	
			...
			dyHistPrefireUp.Add(deepcopy(other.loadHistogram(plotPrefireUp,lumi,zScaleFac)))
			dyHistPrefireDown.Add(deepcopy(other.loadHistogram(plotPrefireDown,lumi,zScaleFac)))
		if antype[2] == 'Mu':		
